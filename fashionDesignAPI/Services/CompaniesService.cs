...
using fashionDesign.Extensions;
...
namespace fashionDesign.Services
{
    public class CompaniesService : ICompaniesService
    {
        ...
        private readonly ICompaniesSetupRepository _setupRepository;
        private readonly IMapper _mapper;

        public CompaniesService(
            ICompaniesRepository companyRepository,
            IUsersRepository userRepository,
            ICompaniesSetupRepository companySetupRepository,
            IMapper mapper)
        {
            _companyRepository = companyRepository;
            _userRepository = userRepository;
            _setupRepository = companySetupRepository;
            _mapper = mapper;
        }
